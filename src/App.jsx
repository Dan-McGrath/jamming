...
function App() {
  ...
  const handleLogin = () => {
    ...
    const redirectUri = "https://dan-mcgrath.github.io/jamming/"; //http://localhost:5173/
  ...
  const handleLogout = () => {
    setParams({});
    window.location.replace("https://dan-mcgrath.github.io/jamming/"); // http://localhost:5173/
  };
